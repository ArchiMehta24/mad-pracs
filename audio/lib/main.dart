...
class _BirdsHomeState extends State<BirdsHome> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              onChange - It is a callback method that is triggered each time the user interacts with the slider. 
              The value paramter represents the current position. 
              */
              Slider(
                min: 0,
              ...
              CircleAvatar(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    /* 
                      if the audio is not currently playing the isPlaying boolean variable will evaluate 
                      to false thus executing the else block which creates a new instance of audio cache called mplayer.
  ...
  String formatTime(Duration duration) {
    // helper function are those functions which execute a part of the function within another function. 
    //These are used to make your program easier to read. They assist in code resusability.
